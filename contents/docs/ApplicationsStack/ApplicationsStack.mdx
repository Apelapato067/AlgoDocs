...
I would just recommend everyone to try coding the algorithm for parentheses matching on their own, and do tell me if you could. We’ll see this segment in the next Docs anyways. Do let me know if you are enjoying the Docs. Bigger things are waiting, just stay!
