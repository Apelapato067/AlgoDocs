...
1. Since in this docs, our main focus is to modify the code for matching parenthesis of a single type to matching multi parentheses., we’ll copy the whole thing from our last docs, from creating the function parenthesisMatch to the stack inside.
