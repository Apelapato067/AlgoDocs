...
We had learned about creating a linked list using C structures and traversing through them while printing the values at each node. Today, we’ll learn how to insert a node at some position and how that is more efficient than inserting an element in an array.
...
2. Create the linkedlistTraversal function. 
